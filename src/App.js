  ...
  render() {
    return (
      <div className="size1 bg0 where1-parent">
        <div className="flex-c-m bg-img1 size2 where1 overlay1 where2 respon2" style={{backgroundImage: '%PUBLIC_URL%/images/bg01.jpg'}}>
        ...
        <div className="size3 flex-col-sb flex-w p-l-75 p-r-75 p-t-45 p-b-45 respon1">
          <div className="wrap-pic1">
            <img src="%PUBLIC_URL%/images/icons/logo.png" alt="LOGO"/>
          </div>
          ...
          <div className="flex-w">
            <a href="index.html#" className="flex-c-m size5 bg3 how1 trans-04 m-r-5">
              <i className="fa fa-facebook"></i>
            </a>
            <a href="index.html#" className="flex-c-m size5 bg4 how1 trans-04 m-r-5">
